...
image = Image.open('hypermetropia.jpg')

st.image(image,caption='hypermetropia')
...
image = Image.open('myopia.jpg')

st.image(image,caption= 'myopia')
if option == "presbyopia":
    if (e>25)and(q<19):
        st.write("you are suffering from prebyopia")
        f=g+e
        st.write("your power is",f)

image = Image.open('presbyopia.jpg')

st.image(image,caption= 'presbyopia')
